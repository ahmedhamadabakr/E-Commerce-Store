    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 py-10">
      <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-xl p-8 flex flex-col md:flex-row gap-8">
        ...
        <div className="md:w-1/2 flex flex-col justify-center">
          <h1 className="text-3xl font-extrabold text-blue-900 mb-3">{product.title}</h1>
          <p className="text-gray-700 mb-5 text-lg leading-relaxed">{product.description}</p>
          <div className="mb-3">
            <span className="block text-gray-500">السعر</span>
            <span className="text-2xl font-bold text-blue-700">{product.price} <span className="text-base font-normal">$</span></span>
          </div>
          <div className="mb-2">
            <span className="block text-gray-500">الكمية المتوفرة</span>
            <span className="font-semibold text-gray-800">{product.quantity}</span>
          </div>
          <div className="mb-2">
            <span className="block text-gray-500">التصنيف</span>
