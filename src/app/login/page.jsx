    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-blue-100 to-blue-200">
      <div className="w-full max-w-md p-8 sm:p-10 bg-white rounded-3xl shadow-2xl border border-blue-100 flex flex-col gap-8">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          ...
          <button
            type="submit"
            className="bg-gradient-to-r from-blue-600 to-blue-400 hover:from-blue-700 hover:to-blue-500 text-white font-bold py-3 rounded-xl shadow-xl text-xl tracking-wide focus:outline-none focus:ring-2 focus:ring-blue-400 transition-all disabled:opacity-60"
            disabled={loading}
          >
        ...
        <div className="flex flex-col gap-2 mt-2 items-center">
          ...
          <Link
            href="/register"
            className="bg-blue-100 hover:bg-blue-200 text-blue-700 font-semibold py-2 px-6 rounded-xl text-center transition-all shadow"
          >
            Register
          </Link>
        </div>
